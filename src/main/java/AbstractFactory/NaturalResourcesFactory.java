...
public class NaturalResourcesFactory implements AbstractFactory {
     ...
     */
    @Override
    public VillageEntity getVillageEntity(String naturalResourceType) throws InvalidNaturalResourcesException {
        return switch (naturalResourceType.toUpperCase()) {
            ...
            default -> throw new InvalidNaturalResourcesException();
        };
    }
}