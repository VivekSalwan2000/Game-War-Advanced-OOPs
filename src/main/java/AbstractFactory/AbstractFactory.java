...
import ConcurrentAbstractFactory.InvalidNaturalResourcesException;
import ConcurrentAbstractFactory.InvalidVillageEntityTypeException;
import ConcurrentAbstractFactory.InvalidWorkerTypeException;
...
public interface AbstractFactory {
     ...
     */
    VillageEntity getVillageEntity(String entityName) throws InvalidVillageEntityTypeException, InvalidBuildingTypeException;
}
