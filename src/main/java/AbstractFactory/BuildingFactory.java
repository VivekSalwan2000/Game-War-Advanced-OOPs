...
public class BuildingFactory implements AbstractFactory {
     ...
     */
    @Override
    public VillageEntity getVillageEntity(String exhaustibleResourceType) throws InvalidBuildingTypeException {
        return switch (exhaustibleResourceType.toUpperCase()) {
            ...
            default -> throw new InvalidBuildingTypeException();
        };
    }
}
