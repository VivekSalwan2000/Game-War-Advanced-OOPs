...
import ConcurrentAbstractFactory.InvalidDefenceTypeException;
...
public class AttackFactory implements AbstractFactory {
     ...
     * @throws InvalidDefenceTypeException throws runtime exception if name does not match required entity
     */
    @Override
    public VillageEntity getVillageEntity(String attackType) throws InvalidDefenceTypeException {
        return switch (attackType.toUpperCase()) {
            ...
            default -> throw new InvalidDefenceTypeException();
        };
    }
}
