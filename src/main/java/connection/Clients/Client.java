...
public class Client extends Thread {
    ...
    /**
     * Opens the socket and completes the initial handshake (connectivity + user verification).
     * Used by both the console client and the JavaFX client.
     */
    ...
    /**
     * @return true when a live socket connection exists
     */
    ...
    public boolean isVillageAvailable() {
        return isVillageAvailable;
    }

    public void setVillageAvailable(boolean villageAvailable) {
        isVillageAvailable = villageAvailable;
    }
        ...
        try {
            ...
            while (condition) {
                ...
                switch (input) {
                    ...
                    case 2 -> {
                        int previousLevel = (villageController != null) ? villageController.getLevel() : -1;
                        VillageController upgraded = upgradeVillage();
                        if (upgraded == null) {
                            System.out.println("Upgrade Failed");
                        } else {
                            villageController = upgraded;
                            if (villageController.getLevel() == previousLevel) {
     ...
     */
    public ChallengeResult randomAttackOnYourVillage() {
        try {
     ...
     */
    public VillageController createVillage() {
     ...
     */
    public VillageController getVillage() {
        VillageController villageController1;
        try {
     ...
     */
    public ChallengeResult fightRandomVillage() {
        try {
     ...
     */
    public Building addBuilding(String buildingType) {
     ...
     */
    public Worker addWorker(String workerType) {
     ...
     */
    public VillageController upgradeVillage() {
        VillageController villageController1;
